package com.ibrahimcanerdogan.masterplayerguide.view.adapter.agent
...
import com.ibrahimcanerdogan.masterplayerguide.util.OnSwipeTouchListener
import com.ibrahimcanerdogan.masterplayerguide.R
import com.ibrahimcanerdogan.masterplayerguide.databinding.ItemAgentBinding
...
class AgentViewHolder(
    ...
    private fun setAgentRole(agentData: AgentData) {
        binding.agentItemRole.apply {
            textViewAgentRoleName.text = agentData.agentRole?.roleDisplayName
            textViewAgentRoleDescription.text = agentData.agentRole?.roleDescription

            Glide.with(imageViewAgentRoleIcon.context)
                .load(agentData.agentRole?.roleDisplayIcon)
